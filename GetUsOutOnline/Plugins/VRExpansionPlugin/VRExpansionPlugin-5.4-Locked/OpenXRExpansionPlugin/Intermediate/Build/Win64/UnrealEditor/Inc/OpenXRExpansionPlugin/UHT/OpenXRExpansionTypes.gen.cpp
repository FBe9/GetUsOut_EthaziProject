...
// End Enum EBPXRResultSwitch

// Begin Enum EVRSkeletalHandIndex
...
// End Enum EVRSkeletalHandIndex

// Begin Enum EXRHandJointType
...
// End Enum EXRHandJointType

// Begin Enum EVROpenXRSkeletonType
...
// End Enum EVROpenXRSkeletonType

// Begin ScriptStruct FBPOpenXRActionSkeletalData
...
struct Z_Construct_UScriptStruct_FBPOpenXRActionSkeletalData_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_WorldScaleOverride_MetaData[] = {
		{ "Category", "Default" },
#if !UE_BUILD_SHIPPING
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bMirrorLeftRight_MetaData[] = {
		{ "Category", "Default" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// If true then the bones will be mirrored from left/right, to allow you to swap a hand mesh to the other hand\n" },
#endif
		{ "ModuleRelativePath", "Public/OpenXRExpansionTypes.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "If true then the bones will be mirrored from left/right, to allow you to swap a hand mesh to the other hand" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_FingerCurls_MetaData[] = {
		{ "Category", "Default" },
#if !UE_BUILD_SHIPPING
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FBPOpenXRActionSkeletalData_Statics::NewProp_SkeletalTransforms = { "SkeletalTransforms", nullptr, (EPropertyFlags)0x0010000080002014, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FBPOpenXRActionSkeletalData, SkeletalTransforms), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SkeletalTransforms_MetaData), NewProp_SkeletalTransforms_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FBPOpenXRActionSkeletalData_Statics::NewProp_bHasValidData = { "bHasValidData", nullptr, (EPropertyFlags)0x0010000080000014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FBPOpenXRActionSkeletalData), &Z_Construct_UScriptStruct_FBPOpenXRActionSkeletalData_Statics::NewProp_bHasValidData_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bHasValidData_MetaData), NewProp_bHasValidData_MetaData) };
...
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FBPOpenXRActionSkeletalData_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_OpenXRExpansionPlugin,
	nullptr,
	&NewStructOps,
...
UScriptStruct* Z_Construct_UScriptStruct_FBPOpenXRActionSkeletalData()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_BPOpenXRActionSkeletalData.InnerSingleton, Z_Construct_UScriptStruct_FBPOpenXRActionSkeletalData_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_BPOpenXRActionSkeletalData.InnerSingleton;
}
// End ScriptStruct FBPOpenXRActionSkeletalData

// Begin ScriptStruct FBPOpenXRSkeletalPair
...
struct Z_Construct_UScriptStruct_FBPOpenXRSkeletalPair_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_OpenXRBone_MetaData[] = {
		{ "Category", "Default" },
		{ "ModuleRelativePath", "Public/OpenXRExpansionTypes.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_BoneToTarget_MetaData[] = {
		{ "Category", "Default" },
		{ "ModuleRelativePath", "Public/OpenXRExpansionTypes.h" },
	};
#endif // WITH_METADATA
...
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FBPOpenXRSkeletalPair_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_OpenXRExpansionPlugin,
	nullptr,
	&NewStructOps,
...
UScriptStruct* Z_Construct_UScriptStruct_FBPOpenXRSkeletalPair()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_BPOpenXRSkeletalPair.InnerSingleton, Z_Construct_UScriptStruct_FBPOpenXRSkeletalPair_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_BPOpenXRSkeletalPair.InnerSingleton;
}
// End ScriptStruct FBPOpenXRSkeletalPair

// Begin ScriptStruct FBPOpenXRSkeletalMappingData
...
struct Z_Construct_UScriptStruct_FBPOpenXRSkeletalMappingData_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bMergeMissingBonesUE4_MetaData[] = {
		{ "Category", "Default" },
#if !UE_BUILD_SHIPPING
...
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FBPOpenXRSkeletalMappingData_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_OpenXRExpansionPlugin,
	nullptr,
	&NewStructOps,
...
UScriptStruct* Z_Construct_UScriptStruct_FBPOpenXRSkeletalMappingData()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_BPOpenXRSkeletalMappingData.InnerSingleton, Z_Construct_UScriptStruct_FBPOpenXRSkeletalMappingData_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_BPOpenXRSkeletalMappingData.InnerSingleton;
}
// End ScriptStruct FBPOpenXRSkeletalMappingData

// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_1vrv_Desktop_GetUsOut_Nueva_carpeta_GetUsOut_Plugins_VRExpansionPlugin_5_4_Locked__1__VRExpansionPlugin_5_4_Locked_OpenXRExpansionPlugin_Source_OpenXRExpansionPlugin_Public_OpenXRExpansionTypes_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EBPXRResultSwitch_StaticEnum, TEXT("EBPXRResultSwitch"), &Z_Registration_Info_UEnum_EBPXRResultSwitch, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1353949064U) },
		{ EVRSkeletalHandIndex_StaticEnum, TEXT("EVRSkeletalHandIndex"), &Z_Registration_Info_UEnum_EVRSkeletalHandIndex, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 236016670U) },
		{ EXRHandJointType_StaticEnum, TEXT("EXRHandJointType"), &Z_Registration_Info_UEnum_EXRHandJointType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3687730021U) },
		{ EVROpenXRSkeletonType_StaticEnum, TEXT("EVROpenXRSkeletonType"), &Z_Registration_Info_UEnum_EVROpenXRSkeletonType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2491445519U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FBPOpenXRActionSkeletalData::StaticStruct, Z_Construct_UScriptStruct_FBPOpenXRActionSkeletalData_Statics::NewStructOps, TEXT("BPOpenXRActionSkeletalData"), &Z_Registration_Info_UScriptStruct_BPOpenXRActionSkeletalData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBPOpenXRActionSkeletalData), 2235388730U) },
		{ FBPOpenXRSkeletalPair::StaticStruct, Z_Construct_UScriptStruct_FBPOpenXRSkeletalPair_Statics::NewStructOps, TEXT("BPOpenXRSkeletalPair"), &Z_Registration_Info_UScriptStruct_BPOpenXRSkeletalPair, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBPOpenXRSkeletalPair), 2008680393U) },
		{ FBPOpenXRSkeletalMappingData::StaticStruct, Z_Construct_UScriptStruct_FBPOpenXRSkeletalMappingData_Statics::NewStructOps, TEXT("BPOpenXRSkeletalMappingData"), &Z_Registration_Info_UScriptStruct_BPOpenXRSkeletalMappingData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBPOpenXRSkeletalMappingData), 1145888911U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_1vrv_Desktop_GetUsOut_Nueva_carpeta_GetUsOut_Plugins_VRExpansionPlugin_5_4_Locked__1__VRExpansionPlugin_5_4_Locked_OpenXRExpansionPlugin_Source_OpenXRExpansionPlugin_Public_OpenXRExpansionTypes_h_3760855533(TEXT("/Script/OpenXRExpansionPlugin"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Users_1vrv_Desktop_GetUsOut_Nueva_carpeta_GetUsOut_Plugins_VRExpansionPlugin_5_4_Locked__1__VRExpansionPlugin_5_4_Locked_OpenXRExpansionPlugin_Source_OpenXRExpansionPlugin_Public_OpenXRExpansionTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_1vrv_Desktop_GetUsOut_Nueva_carpeta_GetUsOut_Plugins_VRExpansionPlugin_5_4_Locked__1__VRExpansionPlugin_5_4_Locked_OpenXRExpansionPlugin_Source_OpenXRExpansionPlugin_Public_OpenXRExpansionTypes_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Users_1vrv_Desktop_GetUsOut_Nueva_carpeta_GetUsOut_Plugins_VRExpansionPlugin_5_4_Locked__1__VRExpansionPlugin_5_4_Locked_OpenXRExpansionPlugin_Source_OpenXRExpansionPlugin_Public_OpenXRExpansionTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_1vrv_Desktop_GetUsOut_Nueva_carpeta_GetUsOut_Plugins_VRExpansionPlugin_5_4_Locked__1__VRExpansionPlugin_5_4_Locked_OpenXRExpansionPlugin_Source_OpenXRExpansionPlugin_Public_OpenXRExpansionTypes_h_Statics::EnumInfo));
// End Registration
